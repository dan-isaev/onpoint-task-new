    ...
    return (
        <div className="slide2">
            ...
            <div className="slide2__schema">
                ...
                <div className="slide2__txt1"><span className="slide2__bigTxt">1</span><br />β-клетки</div>
                ...
                <div className="slide2__txt4"><span className="slide2__bigTxt">4</span><br />Жировые<br />клетки</div>
                <div className="slide2__img5"></div>
                <div className="slide2__txt5"><span className="slide2__bigTxt">5</span><br />Мышцы</div>
                <div className="slide2__img6"></div>
                <div className="slide2__txt6"><span className="slide2__bigTxt">6</span><br />Печень</div>
                <div className="slide2__img7"></div>
                <div className="slide2__txt7"><span className="slide2__bigTxt">7</span><br />Головной<br />мозг</div>
                <div className="slide2__img8"></div>
                <div className="slide2__txt8"><span className="slide2__bigTxt">8</span><br />Почки</div>
